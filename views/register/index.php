    ...
    <body>
        <div class="container">
                    <div id="loginbox" style="margin-top:20px;" class="mainbox col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-2">
                        <form role="form" action="register.php" method="post" autocomplete="on">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-xs-6">
                                                         <div class="input-group">
                                                             ...
                                                             <input type="text" name="pre_post" class="form-control" placeholder="120">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-xs-6">
                                                         <div class="input-group">
                                                             ...
                                                             <input type="text" name="per_post" class="form-control" placeholder="1200">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-xs-6">
                                                         <div class="input-group">
                                                             ...
                                                             <input type="text" name="per_division" class="form-control" placeholder="Dhaka"  >
                                                        </div>
                                                    </div>
                                                </div>
                                              </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-xs-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="std_id" class="form-control" placeholder="" Value="<?php $sid=rand(0,10000); echo "2016".$sid;?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group col-xs-6">
                                                   <div class="input-group">
