                ...
                <div id="loginbox" style="margin-top:20px;" class="mainbox col-md-8 col-md-offset-0 col-sm-8 col-sm-offset-2">
                    <div class="panel panel-primary"> 
                        <div class="panel-heading"><ul class="pager">
                            <li class="previous"><a href="http://localhost/atomic13/views/seip107899/book/">Back</a></li>
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered">
                                 ...
                                 <tr><td><h4><?php echo $books->id ;?></h4></td><td><h4><?php echo $books->title;?></h4></td><td><h4><?php echo $books->author;?></h4></td>
                                       <td width="150">
                                        <form role="form" method="POST" action="delete.php">
                                            <a class="btn btn-success" href="edit.php?id=<?php echo $books->id;?>">Edit</a>
                                            <input type="hidden" name="id" value= "<?php echo $books->id;?>" class="form-control" id="name" value="">
